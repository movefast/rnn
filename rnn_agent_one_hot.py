...
class RNNAgent(agent.BaseAgent):
    def agent_init(self, agent_init_info):
        ...
        self.rnn = SimpleRNN(self.num_states, self.num_states, self.num_actions).to(device)
        self.target_rnn = SimpleRNN(self.num_states, self.num_states, self.num_actions).to(device)
