...
# ### Train
def train(agent_idxes, T=10, lr=1e-3, beta=1, hidden_size=50, alpha=0.1):
    ...
    if agent_idxes[0] == 10:
        file_path = f'metrics/{agent.T}/{agent.step_size}/all_reward_sums_{name_str}_{agent.alpha}.torch'
